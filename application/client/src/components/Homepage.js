 ...
 */
  ...
  /**
   * Sends a request to backend to remove the login cookie
   */
    ...
    <Container className="bg-white">
      ...
      <Tabs>
        ...
        <TabPanel>
          {" "}
          {/* SFSU Customers Tab */}
          <h1 className="text-center mt-5">Welcome, Gator!</h1>
          <br></br>
          <h4>
            ...
            the meanwhile, feel free to browse your restaurant options.
          </h4>
          <br />
          <hr />
